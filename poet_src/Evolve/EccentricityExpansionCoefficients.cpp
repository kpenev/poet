...
namespace Evolve {
    ...
    double EccentricityExpansionCoefficients::p_m2s(double e,
                                                    int s, 
    ...
    double EccentricityExpansionCoefficients::p_0s(double e,
                                                   int s, 
                                                   unsigned max_e_power,
                                                   bool deriv) const
    {
    ...
    double EccentricityExpansionCoefficients::p_p2s(double e,
                                                    int s,
                                                    unsigned max_e_power,
                                                    bool deriv) const
    {
