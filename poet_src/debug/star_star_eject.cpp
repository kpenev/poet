...
int main(int, char **)
{
    ...
    const double PRIMARY_MASS = 1.1922266117013909;
    const double SECONDARY_MASS = 1.1422059207253767;
    const double FEH = -0.13998517587686793;
    const double INITIAL_PERIOD = 4.044934779104382;
//    const double LGQ_MIN = 4.6;
    const double LGQ_BREAK_PERIOD = 2.0 * M_PI / 5.08889636;
    const double LGQ_POWERLAW = -2.17268687;
    const double FINAL_AGE = 1.0813742164483169;

//    double initial_secondary_angmom[] = {1.43525535, 0.43099626};
    double initial_secondary_angmom[] = {1.09625555, 0.34932195};


//    const double DISK_PERIOD = 1.0;
    const double DISK_DISSIPATION_AGE = 0.005;
    ...
    const double DISK_FREQUENCY = 2.8172517168671987;//2.0 * M_PI / DISK_PERIOD;
    double ref_phase_lag = 5.0425039180994065e-08;//15.0 / (16.0 * M_PI * std::pow(10.0, LGQ_MIN));
