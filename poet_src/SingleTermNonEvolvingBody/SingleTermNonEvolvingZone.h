/**\file
 *
 * \brief Declares a class for the single zone of SingleTermNonEvolvingBody
 * objects.
 *
 * \ingroup Planet_group
 */

#ifndef __SINGLE_TERM_NON_EVOLVING_ZONE_H
#define __SINGLE_TERM_NON_EVOLVING_ZONE_H

#include "../Core/SharedLibraryExportMacros.h"
#include "../Evolve/DissipatingZone.h"
#include "../Core/AstronomicalConstants.h"
#include "../Evolve/SingleTermZone.h"

namespace SingleTermNonEvolvingBody {

    ///\brief The only zone of a SingleTermNonEvolvingBody.
    ///
    ///\ingroup Planet_group
    class LIB_LOCAL SingleTermNonEvolvingZone :
        virtual public Evolve::SingleTermZone {
    private:
        double
    ...
    public:
        SingleTermNonEvolvingZone(
            ...
            SingleTermZone(orbital_frequency_multiplier,
    ...
    }; //End SingleTermNonDissipativeZone class.
