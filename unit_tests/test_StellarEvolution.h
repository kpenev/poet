...
protected:
	...
	///Tests the stellar evolution of polynomial quantities with no smoothing.
	///and no mass scaling of age.
	void test_polynomial_evolution()
	{polynomial_evolution_check();}

	///Tests the stellar evolution of polynomial quantities with no smoothing.
	///but low mass tracks age scaling of 1 and high mass tracks age scaling of 2.
