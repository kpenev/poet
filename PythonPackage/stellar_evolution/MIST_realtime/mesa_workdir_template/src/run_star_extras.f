...
!     no diffusion for fully convective, post-MS, and mega-old models 
      ...
      integer function how_many_extra_history_columns(id, id_extra)
          ...
          !Add columns for radius and mass of the bottom boundary of the
          !convective envelope and core and envelope moments of inertia
          ...
          do zone = 1, s% nz, 1
              if (&
                  ...
                  if (&
                          ...
                          & .or. &
                          & s % mixing_type(zone) .eq. minimum_mixing&
                  &) &
                      break = break + s % dm(zone)
              endif
          end do
          if ( .not. found_cz) then
              write(*,*) '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
              write(*,*) 'No surface convective zone found'
              write(*,*) '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
              ierr = 1
          endif
      ...
      subroutine data_for_extra_history_columns(id, id_extra, n, names, vals, ierr)
          ...
          names(5) = 'core_outer_i'
          vals(5) = conv_bottom_zone
