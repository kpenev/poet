...
goodConfigurationsFile = open('./part1/part1goodconfig4.txt', 'w')

fastrotationsfile = open('./part1/fastrotationsgoodconfig4.txt', 'w')
mediumrotationsfile = open('./part1/mediumrotationsgoodconfig4.txt', 'w')
slowrotationsfile = open('./part1/slowrotationsgoodconfig4.txt', 'w')

logQinr4file = open('./part1/logQinr4GoodConfig4.txt', 'w')
logQinr5file = open('./part1/logQinr5GoodConfig4.txt', 'w')
logQinr6file = open('./part1/logQinr6GoodConfig4.txt', 'w')

logQ6file = open('./part1/logQ6GoodConfig4.txt', 'w')
logQ7file = open('./part1/logQ7GoodConfig4.txt', 'w')
logQ8file = open('./part1/logQ8GoodConfig4.txt', 'w')
...
np.savetxt('./part1/Part1PlanetObliquityCounts4.txt', planetObliquityCounts, header = 'Name Fast Medium Slow logQinr4 logQinr5 logQinr6 logQ6 logQ7 logQ8', fmt='%s')
np.savetxt('./part1/Part1PlanetObliquityProportions4.txt', planetObliquityProportions, header = 'Name Fast Medium Slow logQinr4 logQinr5 logQinr6 logQ6 logQ7 logQ8', fmt='%s')
np.savetxt('./part1/part1goodconfigarray4.txt', np.array(goodConfigurations), fmt='%s')
