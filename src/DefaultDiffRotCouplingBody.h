#ifndef __DEFAULT_DIFF_ROT_COUPLING_BODY_H
#define __DEFAULT_DIFF_ROT_COUPLING_BODY_H

#include "DissipatingBody.h"

/**\file
 *
 * \brief Declares a DissipatingBody with default differential rotation
 * coupling.
 *
...
class DefaultDiffRotCouplingBody : public DissipatingBody {
private:
